...
{
    /// <summary>
    /// Represents a log link item in the header dropdown menu.
    /// </summary>
    [Section<SectionAppHelpSecondary>]
    ...
    public sealed class FragmentHeaderLogging : FragmentControlDropdownItemLink
    {
        ...
        /// </param>
        public FragmentHeaderLogging(IFragmentContext fragmentContext, ISitemapManager sitemapManager)
            : base(fragmentContext)
        {
            Text = _ => "vila:vila.log.label";
            Uri = _ => sitemapManager.GetUri<WWW.Log.Index>(fragmentContext?.ApplicationContext);
        }
